...
Collapsing loops may subtly effect the compilers knowledge about alignment and effect vectorisation.
...
\begin{itemize}
  \item Turn on support with \mintinline{fortran}|OMP_NESTED=true|, otherwise inner region is default serial.
...
\begin{itemize}
  ...
  \item Nicer to split up the directive across lines in the source file.
\end{itemize}
